        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="py-4 text-left px-6">
                    ...
                    <!-- Registration Form -->
                    <div class="text-white text-center font-bold p-4 rounded mb-4" :class="reg_alert_variant">
                        {{ reg_alert_msg }}
...
import { mapState, mapWriteableState,mapActions } from "pinia";
